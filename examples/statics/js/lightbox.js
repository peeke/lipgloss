(function () {
  ...
  function (_Transition) {
    ...
    function AnimationTransition() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(AnimationTransition).apply(this, arguments));
    }
      ...
      value: _async$4(function () {
        ...
        return _awaitIgnored$2(new Promise(function (resolve) {
          var animationEnd = function animationEnd(e) {
            ...
            _this._view.removeEventListener('animationend', animationEnd);

            resolve();
          };

          _this._view.addEventListener('animationend', animationEnd);
        }));
      })
      /**
       *
