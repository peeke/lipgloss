...
},{"./utils/dispatchEvent":8,"./Config":7}],4:[function(require,module,exports) {
"use strict";
...
var View = function () {
  ...
  _createClass(View, [{
      ...
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (this._options.name === 'main') console.log('deactivate');
              ...
              case 3:
                ...
                if (this._options.name === 'main') console.log('persists?', this._persist);
    ...
    set: function set(model) {
      ...
      if (this._options.name === 'main') console.log('set model', model);
      ...
      if (this._options.name === 'main') console.log('htmlContainsViews', htmlContainsViews);
...
},{"./Transition":5,"./Config":7}],6:[function(require,module,exports) {
"use strict";
...
var Controller = function () {
  ...
  _createClass(Controller, [{
    ...
    value: function _onLinkClick(e) {
      ...
      console.log(e.currentTarget, attr('data-view-hint'));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                console.log('navigate to url', url, includes);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                if (!this._isCurrentUrl(this._model.url)) {
                  _context2.next = 7;
                  break;
                }
...
},{"./View":4,"./Model":6,"./Transition":5,"./Config":7,"./utils/dispatchEvent":8}],2:[function(require,module,exports) {
"use strict";
...
},{"./Controller":3,"./View":4,"./Model":6,"./Transition":5}],1:[function(require,module,exports) {
"use strict";
...
},{"regenerator-runtime/runtime":9,"../../src/index":2}]},{},[1])