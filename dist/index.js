(function (global, factory) {
  ...
  (global = global || self, factory(global.lipgloss = {}));
  ...
  function () {
     ...
     */
    function Transition(element, milestones) {
    ...
    _createClass(Transition, [{
      ...
      key: "exit",
      value: _async(function (docPromise) {
        var _this = this;

        _this.element.removeAttribute(attributes.transition);

        reflow(_this.element);

        _this.element.setAttribute(attributes.transition, 'out');
      })
    }, {
      key: "beforeEnter",
      value: function () {
      ...
      value: _async(function (newNode, newDoc) {
        ...
        _this2.element.removeAttribute(attributes.transition);

        reflow(_this2.element);

        _this2.element.setAttribute(attributes.transition, 'in');
      })
      /**
  ...
  function () {
    ...
    _createClass(View, [{
      ...
      value: _async$2(function (model, milestones) {
        ...
        var milestone = milestones[_this2.name];
        var transition = new _this2._options.transition(_this2._element, milestones);
        _this2._model = model;
        _this2.loading = true;
        ...
        return _invoke(function () {
          ...
          return _await$2(model.doc, function (doc) {
            ...
            return _await$2(transition.beforeEnter(node, doc), function () {
              _this2.visible = true;
              _this2.active = true;
